...
<head>
    ...
    <title>Memes</title>
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="./assets/css/images/favicon/apple-touch-icon.png">
    ...
    <link rel="manifest" href="./assets/css/images/favicon/site.webmanifest">
    <link rel="mask-icon" href="./assets/css/images/favicon/safari-pinned-tab.svg" color="#5bbad5">
