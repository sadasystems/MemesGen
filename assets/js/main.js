...
(function($) {
	...
	$.getJSON("/api/?table_name=memes_saved", function(data){
		...
		// had issue with
			if (typeof data.data.memes_likes.values[i].likes != 'undefined') { data.data.memes_saved.values[i].likes = data.data.memes_likes.values[i].likes; }  
			else { data.data.memes_saved.values[i].likes = 0; }
